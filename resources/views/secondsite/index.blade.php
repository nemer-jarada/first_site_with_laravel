...
@section('title', 'Tiger MJ')
@section('content')
    <section class="page-section clearfix">
        <div class="container">
            <div class="intro">
                <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="{{ asset('secondsite/assets/img/intro.jpg') }}"
                    alt="..." />
                <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                    ...
                    <p class="mb-3">Every cup of our quality artisan coffee starts with locally sourced, hand
                        ...
                        morning routine - we guarantee it!</p>
                ...
                <div class="col-xl-9 mx-auto">
                    <div class="cta-inner bg-faded text-center rounded">
                        ...
                        <p class="mb-0">When you walk into our shop to start your day, we are dedicated to
                            ...
                            products made with the highest quality ingredients. If you are not satisfied, please let us
